...
<br/><br/>
<div id="apDiv1">
  <h2 align="center">工资信息查询</h2>
  <br/>
  <form id="form1" name="form1" method="post" action="wageEdit01">
  <p>
    <label for="textfield">员工编号:</label>
    <input type="text" name="staff_no" id="textfield">
  </p>
    <p>
    <label for="textfield">发放年月:</label>
    <input type="text" name="wage_date" id="textfield2">
  </p>
  <p align="center">
