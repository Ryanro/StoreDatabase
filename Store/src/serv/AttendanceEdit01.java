...
public class AttendanceEdit01 extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{	
			...
			request.getRequestDispatcher("attendanceEdit.jsp?msg="+msg).forward(request, response);
		}else
		{
			request.setAttribute("attendance", attendance);
			request.getRequestDispatcher("attendanceEdit02.jsp").forward(request, response);
		}
	}
